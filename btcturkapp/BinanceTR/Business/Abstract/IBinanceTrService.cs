...
namespace BinanceTR.Business.Abstract
{
    public interface IBinanceTrService
    {
        ...
        /// <returns></returns>
        Task<IDataResult<List<AccountAsset>>> GetAccountInformationAsync(CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<IDataResult<AssetInformationData>> GetAssetIformationAsync(string assetName, CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<IDataResult<OrderDetailData>> PostNewLimitOrderAsync(string symbol, OrderSideEnum side, decimal origQuoteQty, string price, CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<IDataResult<PostOrderModelData>> PostBuyMarketOrderAsync(string symbol, decimal origQty, CancellationToken ct = default);
        ...
        /// <param name="origQuoteQty">Sipariş adedi (Örnek: 0.000056M, 7, 1.6M)</param>
        /// <returns></returns>
        Task<IDataResult<PostOrderModelData>> PostSellMarketOrderAsync(string symbol, decimal origQuoteQty, CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<IDataResult<PostOrderModelData>> PostStopLimitOrderAsync(string symbol, OrderSideEnum side, decimal origQuoteQty, decimal limitPrice, decimal stopPrice, CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<IDataResult<OrderDetailData>> GetOrderByIdAsync(long orderId, CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<IDataResult<CancelOrderData>> CancelOrderByIdAsync(long orderId, CancellationToken ct = default);
        ...
        /// <param name="limit">Varsayılan: 500, Maksimum: 1000</param>
        /// <returns></returns>
        Task<IDataResult<List<OpenOrderList>>> GetAllOrdersAsync(string symbol, int limit = 500, CancellationToken ct = default);
        ...
        /// <param name="limit">Varsayılan: 500, Maksimum: 1000</param>
        /// <returns></returns>
        Task<IDataResult<List<OpenOrderList>>> GetAllOpenOrdersAsync(string symbol, int limit = 500, CancellationToken ct = default);
        ...
        /// <param name="limit">Varsayılan: 500, Maksimum: 1000</param>
        /// <returns></returns>
        Task<IDataResult<List<OpenOrderList>>> GetAllOpenBuyOrdersAsync(string symbol, int limit = 500, CancellationToken ct = default);
        ...
        /// <param name="limit">Varsayılan: 500, Maksimum: 1000</param>
        /// <returns></returns>
        Task<IDataResult<List<OpenOrderList>>> GetAllOpenSellOrdersAsync(string symbol, int limit = 500, CancellationToken ct = default);
        ...
        /// <returns></returns>
        //Task<IDataResult<OcoOrderData>> PostOcoOrderAsync(string symbol, OrderSideEnum side, decimal quantity, decimal price, decimal stopPrice, decimal stopLimitPrice, CancellationToken ct = default);
    }
}
