...
namespace Binance.BinanceV1
{
    public class BinanceV1 : IBinanceClient
    {
        ...
        //    var returnModel = response.ToReturnModel<IList<UserBalanceBinance>>();
        ...
        public async Task<TickerBinance> GetTicker(string pairSymbol)
        {
            ...
            var returnModel = response.ToReturnModel<TickerBinance>();
        ...
        {
            var stamp = DateTimeOffset.UtcNow.ToUnixTimeMilliseconds() - 10800000;
